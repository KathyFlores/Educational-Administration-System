...
urlpatterns = [
    ...
    url('problem_bank/subject', views.subject, name='subject'),
    url('problem_bank/chapter', views.chapter, name='chapter'),
    url('problem_bank/knowledge_point', views.knowledge_point, name='knowledge_point'),
